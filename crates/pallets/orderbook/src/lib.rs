...
pub const KEY_TYPE: KeyTypeId = KeyTypeId(*b"ordr");
...
// #[derive(Clone, Encode, Decode, Eq, PartialEq, RuntimeDebug, Default,
// parity_scale_codec::MaxEncodedLen, TypeInfo)] #[derive(Clone, Encode, Decode, Eq, PartialEq,
// RuntimeDebug, Default, parity_scale_codec::MaxEncodedLen, TypeInfo)] pub struct
// OrderData<AccountId> { 	// issuance: Balance,
// 	issuance: u32,
// 	minter: AccountId,
// 	burner: AccountId,
// 	// starknetAddress:pallet_
// 	// amount:
// 	// amount:
// 	// limit_price:
// 	// slippage_tolerance:
...
use starknet_api::transaction::{Calldata, Event as StarknetEvent, Fee, MessageToL1, TransactionHash};
    ...
    // pub struct Order<ContractAddress> {
    //     issuance: u128,
    ...
    //     limit_price:u128,
    //     // relayer:Option<ContractAddress>,
    //     // minter: AccountId,
    //     // burner: AccountId,
    // }
    ...
    // // impl Default for MetaData<AccountId, Balance> {
    // impl Default for Order{
    //     fn default() -> Self {
    //         // let balance = Balance::new();
    //         Order {
    //             // issuance: Some(balance),
    //             issuance:Some(u128::new(0) )
    //             deposit:Some(u128::new(0) )
    //             filled:Some(u128::new(0) )
    //             amount:Some(u128::new(0) )
    //             slippage_tolerance:Some(u128::new(0) )
    //             limit_price:Some(u128::new(0) )
    //             issuance:Some(u128::new(0) )
    //             // minter: (), burner: ()
    //         }
    //     }
    ...
    pub(super) type OrderbookStore<T: Config> = StorageValue<_, Order, ValueQuery>;
    // pub(super) type OrderbookStore<T: Config> = StorageValue<_, Order<ContractAddress>, ValueQuery>;

    
    // #[pallet::storage]
    // #[pallet::getter(fn order_by_users)]
    // pub(super) type OrderByUsersStore<T: Config> = StorageValue<_, ContractAddress, Order, ValueQuery>;
